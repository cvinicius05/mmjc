 ...
 * tipo de um vari&aacute;vel em forma de um objeto &uacute;nico.
 * <p>
 * Associado a cada string de tipo encontrada no programa &eacute;
 * criado um novo s&iacute;mbolo para esse tipo que &eacute; uma
 * representa&ccedil;&atilde;o &uacute;nica desse tipo. Dessa 
 * forma, a compara&ccedil;&atilde;o de tipos &eacute; feita por
 * meio dos s&iacute;mbolos de cada tipo, evitando a 
...
public class TypeSymbol {
	 ...
	 * representa o tipo.
	 * 
	 * @param ptype representa o token do tipo <b>PType</b>.
	 ...
	 * 
	 * @param s representa string a ser traduzida. 
	 * @return novo s&iacute;mbolo associado a string de entrada.
	 */
	private static TypeSymbol getFromString(String s){
		String u = s.intern();
