...
public class SemanticError {
	...
	public static String invalidReturnType(TId mid, TypeSymbol rmtype, TypeSymbol retype) {
		return err+mid.getLine()+','+mid.getPos()+"]:\n\tThe expression returned by method \'"+mid.getText()+"\' has type <"+retype+">, but <"+rmtype+"> was expected.";
	}
}